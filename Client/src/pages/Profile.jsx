  ...
  useEffect(() => {
    ...
    const fetchProfileData = async () => {
      try {
        ...
        console.log(hostedRes);

        const hosted =
          hostedRes.data.data?.events ||
          hostedRes.data.events ||
          hostedRes.data.data ||
          hostedRes.data ||
          [];
        ...
        const registeredRes = await axios.get(
          `/api/user/registered-events/${userId}`,
          { headers: { Authorization: accessToken } }
        );
        ...
        const registered =
          ...
          registeredRes.data.data?.events ||
          registeredRes.data.data ||
          [];
